...
public class TopOffer {
    ...
    public String toString() {
        ...
        sb.append(TopOffer.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
        ...
        sb.append('=');
        sb.append(((this.isShowBanner == null)?"<null>":this.isShowBanner));
        sb.append(',');
